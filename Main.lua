    ...
    function Library.Window(Title, Size)
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:Toggle(Options)
                    ...
                    Utility.AddConnection(UserInput.InputBegan, function(Input, Useless)
                        ...
                        if Input.UserInputType == Enum.UserInputType.Touch and Utility.OnMouse(ToggleHitbox) then
                ...
                function Section:Slider(Options)
                    ...
                    Utility.AddConnection(UserInput.InputBegan, function(Input, Useless)
                        ...
                        if Input.UserInputType == Enum.UserInputType.Touch and Utility.OnMouse(SliderOutline) then
                            Slider:Refresh()
                    ...
                    Utility.AddConnection(UserInput.InputChanged, function(Input, Useless)
                        ...
                        if Input.UserInputType == Enum.UserInputType.Touch and Slider.Dragging then
                            Slider:Refresh()
                        end
                    end)
                    --
                ...
                function Section:Button(Options)
                    ...
                    Utility.AddConnection(UserInput.InputBegan, function(Input, Useless)
                        ...
                        if Input.UserInputType == Enum.UserInputType.Touch and Utility.OnMouse(ButtonOutline) then
                            for Index, Value in pairs(Tab.Dropdowns[Side]) do
                                if Value then
                                    return
                                end
                ...
                function Section:Dropdown(Options)
                    ...
                    for Index, Value in pairs(Options.List) do
                        ...
                        Utility.AddConnection(UserInput.InputBegan, function(Input, Useless)
                            ...
                            if Input.UserInputType == Enum.UserInputType.Touch and Utility.OnMouse(SelectionInline) then
                                Dropdown:Set(Value)
                            end
                        end)
                        --
            ...
            Utility.AddConnection(UserInput.InputBegan, function(Input, Useless)
                ...
                if Input.UserInputType == Enum.UserInputType.Touch and Utility.OnMouse(TabInline) then
                    task.spawn(function()
                        --[[
                            local Speed = 4
